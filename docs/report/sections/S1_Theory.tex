...
\texttt{benchmarks/01_cylinder_compression/}, \texttt{tests/} &
TODO \

13 &
Perform a mesh-convergence study &
\texttt{benchmarks/01_cylinder_compression/experiment.yaml}, \texttt{tests/} &
TODO \
...
\texttt{benchmarks/01_cylinder_compression/}, \texttt{io/} &
TODO \
